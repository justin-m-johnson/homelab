...
resource "proxmox_vm_qemu" "Splunk-vm" {
    ...
    vmid = "500"
    name = "splunk.home.initcyber.net"
    desc = "Splunk Virtual Machine"
    ...
    ipconfig0 = "ip=172.16.10.20/24,gw=172.16.10.1"
...
###########Start Ansible Provisioner########################
    ...
    provisioner "local-exec" {
        ...
        command = "ansible-playbook -u ${var.user} --key-file ${var.ssh_keys["priv"]} -i 172.16.10.20, MOTD.yml"
    }  
}